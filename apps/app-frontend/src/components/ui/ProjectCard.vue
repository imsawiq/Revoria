...
<template>
	<div
		class="bg-[--color-glass-bg-strong] border border-[--glass-border] shadow-[--glass-shadow] rounded-xl overflow-clip cursor-pointer transition-colors hover:bg-[--color-button-bg-hover]"
