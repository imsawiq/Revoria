...
const messages = defineMessages({
	...
	loading: {
		id: 'instance.worlds.loading',
		defaultMessage: 'Loading...',
	},
	online: {
		id: 'instance.worlds.online',
		defaultMessage: 'online',
	},
	offline: {
		id: 'instance.worlds.offline',
		defaultMessage: 'Offline',
	},
	notPlayedYet: {
		id: 'instance.worlds.not-played-yet',
		defaultMessage: 'Not played yet',
	},
	incompatibleVersion: {
		id: 'instance.worlds.incompatible-version',
...
<template>
	<SmartClickable>
		...
		<div
			class="grid grid-cols-[auto_minmax(0,3fr)_minmax(0,4fr)_auto] items-center gap-2 p-3 bg-[--color-glass-bg-strong] border border-[--glass-border] shadow-[--glass-shadow] smart-clickable:highlight-on-hover rounded-xl transition-colors hover:bg-[--color-button-bg-hover]"
			:class="{
