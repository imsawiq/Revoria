...
<template>
	<SmartClickable>
		...
		<div
			class="grid grid-cols-[auto_minmax(0,3fr)_minmax(0,4fr)_auto] items-center gap-2 p-3 bg-[--color-glass-bg-strong] border border-[--glass-border] shadow-[--glass-shadow] rounded-xl smart-clickable:highlight-on-hover transition-colors hover:bg-[--color-button-bg-hover]"
		>
			<Avatar
