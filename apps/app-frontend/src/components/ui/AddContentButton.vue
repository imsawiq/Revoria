...
const messages = defineMessages({
	installContent: { id: 'add-content-button.install-content', defaultMessage: 'Install content' },
	addFromFile: { id: 'add-content-button.add-from-file', defaultMessage: 'Add from file' },
})
