...
<template>
	<div
		class="grid grid-cols-[min-content] fixed rounded-2xl top-[--top-bar-height] mt-6 right-6 p-4 z-10 bg-[--color-glass-bg-strong] border border-[--glass-border] shadow-[--glass-shadow]"
		:class="{
