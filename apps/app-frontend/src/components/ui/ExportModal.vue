...
const messages = defineMessages({
	header: { id: 'export-modal.header', defaultMessage: 'Export modpack' },
	modpackName: { id: 'export-modal.modpack-name', defaultMessage: 'Modpack Name' },
	modpackNamePlaceholder: {
		id: 'export-modal.modpack-name.placeholder',
		defaultMessage: 'Modpack name',
	},
	versionNumber: { id: 'export-modal.version-number', defaultMessage: 'Version number' },
	description: { id: 'export-modal.description', defaultMessage: 'Description' },
	descriptionPlaceholder: {
		id: 'export-modal.description.placeholder',
		defaultMessage: 'Enter modpack description...',
	},
	selectFilesHeading: {
		id: 'export-modal.select-files-heading',
		defaultMessage: 'Select files and folders to include in pack',
	},
	cancel: { id: 'action.cancel', defaultMessage: 'Cancel' },
	export: { id: 'export-modal.export', defaultMessage: 'Export' },
})
	...
	<ModalWrapper ref="exportModal" :header="formatMessage(messages.header)">
		<div class="modal-body">
			<div class="labeled_input">
				<p>{{ formatMessage(messages.modpackName) }}</p>
			...
			<div class="labeled_input">
				<p>{{ formatMessage(messages.versionNumber) }}</p>
				<div class="iconified-input">
					<VersionIcon />
			...
			<div class="table">
				<div class="table-head">
					<div class="table-cell row-wise">
						{{ formatMessage(messages.selectFilesHeading) }}
						<Button
