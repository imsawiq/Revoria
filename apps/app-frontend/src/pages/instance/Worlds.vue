<template>
	...
	<ConfirmModalWrapper
		...
		"
		:description="
			formatMessage(messages.removeServerDescription, {
				name: serverToRemove?.name,
				address:
					serverToRemove?.address && serverToRemove?.address !== serverToRemove?.name
						? ` (${serverToRemove.address})`
						: '',
			})
		"
		:markdown="false"
		...
		<div class="flex flex-wrap gap-2 items-center">
			<div class="iconified-input flex-grow">
				...
				<input
					...
					type="text"
					:placeholder="formatMessage(messages.searchWorldsPlaceholder)"
	...
	<div v-else class="w-full max-w-[48rem] mx-auto flex flex-col mt-6">
		<RadialHeader class="">
			<div class="flex items-center gap-6 w-[32rem] mx-auto">
				...
				<span class="text-contrast font-bold text-xl"> {{ formatMessage(messages.emptyWorlds) }} </span>
			</div>
		</RadialHeader>
...
onMounted(async () => {
	...
	protocolVersion.value = await get_profile_protocol_version(instance.value.path).catch(() => null)

	unlistenProfile = await profile_listener(async (e: ProfileEvent) => {
...
const messages = defineMessages({
	thisServer: {
		id: 'instance.worlds.this-server',
		defaultMessage: 'this server',
	},
	removeServerTitle: {
		id: 'instance.worlds.remove-server.title',
		defaultMessage: 'Are you sure you want to remove {name}?',
	},
	removeServerDescription: {
		id: 'instance.worlds.remove-server.description',
		defaultMessage:
			"'{name}'{address} will be removed from your list, including in-game, and there will be no way to recover it.",
	},
	deleteWorldTitle: {
		id: 'instance.worlds.delete-world.title',
		defaultMessage: 'Are you sure you want to permanently delete this world?',
	},
	deleteWorldDescription: {
		id: 'instance.worlds.delete-world.description',
		defaultMessage: "'{name}' will be permanently deleted, and there will be no way to recover it.",
	},
	searchWorldsPlaceholder: {
		id: 'instance.worlds.search.placeholder',
		defaultMessage: 'Search worlds...',
	},
	refreshing: {
		id: 'instance.worlds.refreshing',
		defaultMessage: 'Refreshing...',
	},
	refresh: {
		id: 'instance.worlds.refresh',
		defaultMessage: 'Refresh',
	},
	addServer: {
		id: 'instance.worlds.add-server',
		defaultMessage: 'Add a server',
	},
	emptyWorlds: {
		id: 'instance.worlds.empty',
