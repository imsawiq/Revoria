				...
				<ButtonStyled circular type="transparent">
					...
					>
						...
						<template #install-elsewhere>
							...
							{{ formatMessage(messages.installElsewhere) }}
						</template>
...
const messages = defineMessages({
	...
	installElsewhere: { id: 'install-elsewhere', defaultMessage: 'Install elsewhere' },
	openInBrowser: { id: 'open-in-browser', defaultMessage: 'Open in browser' },
})
