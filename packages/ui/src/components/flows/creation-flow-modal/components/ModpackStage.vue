<template>
	<div class="flex flex-col gap-4">
		<span class="font-semibold text-contrast">{{ formatMessage(messages.prompt) }}</span>
		<Combobox
			...
			:no-options-message="
				searchLoading ? formatMessage(messages.loading) : formatMessage(messages.noResults)
			"
...
import { defineAsyncComponent, h, markRaw, onMounted, ref, watch } from 'vue'
...
const messages = defineMessages({
	prompt: {
		id: 'creation-flow.modpack.prompt',
		defaultMessage: 'Already know the modpack you want to install?',
	},
	searchPlaceholder: {
		id: 'creation-flow.modpack.search.placeholder',
	...
	noResults: {
		id: 'creation-flow.common.no-results',
		defaultMessage: 'No results found',
	},
	or: {
		id: 'creation-flow.common.or',
		defaultMessage: 'or',
	},
	importModpack: {
		id: 'creation-flow.modpack.import',
		defaultMessage: 'Import modpack',
	},
	browseModpacks: {
		id: 'creation-flow.modpack.browse',
