...
const messages = defineMessages({
	title: {
		id: 'creation-flow.import.title',
		defaultMessage: 'Launcher instances',
	},
	clearAll: {
		id: 'creation-flow.import.clear-all',
		defaultMessage: 'Clear all',
	},
	detecting: {
		id: 'creation-flow.import.detecting',
		defaultMessage: 'Detecting launcher instances...',
	},
	searchPlaceholder: {
		id: 'creation-flow.import.search.placeholder',
		defaultMessage: 'Search instance name',
	},
	addLauncherPath: {
		id: 'creation-flow.import.add-launcher-path',
		defaultMessage: 'Add launcher path',
	},
	pathPlaceholder: {
		id: 'creation-flow.import.path.placeholder',
		defaultMessage: 'Path to launcher...',
	},
	add: {
		id: 'creation-flow.common.add',
		defaultMessage: 'Add',
	},
})
