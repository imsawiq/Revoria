          ...
          /> -->
					<div class="grid lg:grid-cols-5 grid-cols-3 gap-4">
						<button
							...
							:style="{
								backgroundColor:
									serverLoader === loader ? 'var(--color-button-bg-selected)' : undefined,
								color: serverLoader === loader ? 'var(--color-button-text-selected)' : undefined,
								borderColor: serverLoader === loader ? 'var(--color-brand)' : undefined,
							}"
