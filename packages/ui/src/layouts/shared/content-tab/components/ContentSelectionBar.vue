...
import { commonMessages, commonProjectTypeSentenceMessages } from '#ui/utils/common-messages'
...
const selectedCountText = computed(() => {
	...
	if (props.contentTypeLabel) {
		return formatMessage(messages.selectedCount, {
			count,
			contentType: formatContentType(props.contentTypeLabel, count),
		})
	}
...
const bulkProgressMessage = computed(() => {
	...
	const contentType = props.contentTypeLabel
		? formatContentType(props.contentTypeLabel, props.bulkTotal)
		: 'items'
	const messageMap = {
