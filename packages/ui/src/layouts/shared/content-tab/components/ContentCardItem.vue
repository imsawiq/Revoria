...
<template>
	...
	>
		<div
			...
			:class="[
				hideActions ? 'flex-1' : 'flex-1 @[700px]:w-[320px] @[700px]:shrink-0 @[700px]:flex-none',
				...
				<div class="flex min-w-0 flex-col gap-0.5">
					...
					<div class="flex min-w-0 items-center gap-1">
						...
						<template v-if="version">
							<BulletDivider class="shrink-0 @[700px]:hidden" />
							<AutoLink
								:target="
								...
								"
								:to="versionLink"
								class="truncate text-sm leading-5 text-secondary !decoration-secondary @[700px]:hidden"
		...
		<div
			class="hidden flex-col gap-0.5 @[700px]:flex"
			:class="[
