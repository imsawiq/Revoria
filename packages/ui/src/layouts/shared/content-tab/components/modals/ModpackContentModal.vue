...
const filterOptions = computed(() => {
	...
	return Object.entries(frequency)
		...
		.map(([type]) => ({
			id: type,
			label: formatMessage(getProjectTypeLabel(type, 2), { count: 2 }),
		}))
})
				...
				<div v-else class="@container flex-1 min-h-0 flex flex-col">
					...
					>
						<div
							...
							:class="
								props.enableToggle
									? 'flex-1 @[700px]:w-[320px] @[700px]:shrink-0 @[700px]:flex-none'
									: 'flex-1'
							"
						>
							<Checkbox
						...
						<div
							...
							:class="props.enableToggle ? 'w-[300px] min-w-0' : 'flex-1'"
						>
							<span class="font-semibold text-secondary">{{
