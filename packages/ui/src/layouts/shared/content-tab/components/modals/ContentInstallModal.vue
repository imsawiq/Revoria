		...
		>
			<div class="flex items-start gap-3 px-6">
				...
				<ButtonStyled type="outlined" circular>
					<button
						v-tooltip="
							formatMessage(
								hideUninstallable ? messages.showUnavailable : messages.hideUnavailable,
							)
						"
			...
			<div v-else class="flex flex-col gap-1">
				...
				>
					<button
						v-tooltip="
							!inst.compatible ? formatMessage(messages.incompatibleInstanceTooltip) : undefined
						"
